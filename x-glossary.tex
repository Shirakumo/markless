...
\defineglossary{compilation}{
  The process by which input data of a certain \g{format}, typically a \g{string}, is interpreted with a set of rules and transformed into a different, output \g{format}.
}
...
\defineglossary{document}{
  ...
  3) The result of the \g{compilation} of a Markless document.
}
...
\defineglossary{signalling}{
  The act by which an \g{implementation} can give feedback about the \g{compilation} of the \g{document}.
}
