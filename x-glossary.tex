...
\defineglossary{directive}{
  A directive associates an \g{identifier} to a \g{textual component}. The string within the \g{identifier} thus belongs to the associated \g{textual component} in the resulting \g{document}.
}
