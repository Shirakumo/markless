...
The effect of a \g{textual component} on its \g{text} applies on all \gpl{level}. In the case of conflicting \gpl{style}, the \g{style} of the \g{textual component} on the closest \g{level} above the \g{text} apply. In effect this means that a \g{textual component} on a lower \g{level} can override a \g{style} for its \g{text}.  \\
