...
When \g{processing} the input \g{document}, the following steps are taken in order, starting again from the beginning until the \g{document} \g{textual component} is ended.
