...
An \g{implementation} must at least support the parameters specified in this section if permitted by the output \g{document}, but may add additional parameters the implications of which are completely \g{implementation dependant}. If the output \g{document} does not support a particular parameter, a \g{warning} is \glink{signalling}{signalled}. \\
