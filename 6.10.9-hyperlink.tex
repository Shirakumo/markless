...
\item As an internal reference, contained in the \inline$internal$ \g{binding}. The target is set to the position of the \g{textual component} associated with the \g{label} of the same name as the contents of the binding.
\end{enumerate}
