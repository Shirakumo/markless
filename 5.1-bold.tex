...
The bold \g{directive} marks the \g{text} to belong to a \g{textual component} that sets the weight of the font to bold. Only the \g{text} held by the \g{content binding} is outputted to the \g{resulting textual component}. \\
