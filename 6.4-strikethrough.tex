...
Strikethrough is an \g{inline directive}. It marks the \g{text} to belong to a \g{textual component} that sets the style of the text to strikethrough. Only the \g{text} held by the \g{content binding} is outputted to the \g{resulting textual component}. \\
