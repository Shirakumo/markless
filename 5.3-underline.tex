...
The underline \g{directive} marks the \g{text} to belong to a \g{textual component} that sets the style of the text to underline. Only the \g{text} held by the \inline{content} binding is outputted to the \g{textual component}. \\
