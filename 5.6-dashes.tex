...
If the \g{document} does not have direct support for em-dashes, a fallback character may be used when appropriate instead. In unicode encoded documents, this should be \unicode{2014}. \\
